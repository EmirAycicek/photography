        ...
        <div className='mx-auto max-w-2xl sm:text-center'>
          ...
          <Fade direction='up' delay={800} cascade damping={1e-1} triggerOnce={true}>
            <p className='mt-6 text-lg leading-8 '>
              Create the memories & celebrate the magic with Solene - a beatifully designed wedding photography theme that has it all
            </p>
          </Fade>
        ...
        <Fade direction='up' delay={800} cascade damping={1e-1} triggerOnce={true}>
            <div className='mx-auto mt-16 max-w-2xl ring-1 ring-gray-200 rounded-3xl sm:mt-20 lg:mx-0 lg:flex lg:max-w-none'>
              ...
              <div className='p-8 sm:p-10 lg:flex-auto'>
                ...
                <p className='mt-6 text-base leading-7'>Create the memories & celebrate the magic with Solene - a beatifully designed wedding photography theme that has it all </p>
              ...
              {/** Right Section */}
              <div className='-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md flex-shrink-0'>
