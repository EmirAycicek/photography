...
const features = [
    {
    name:'PHOTOGRAPHY',
    description: "It's wide array of extremely useful @ user-friendly elements and features turn website creation into a cakewalk. Get started now & see just how east its is to make the website you always wanted.",
            ...
            <div className='flex flex-col'>
                <div className='mx-auto max-w-7xl text-center'>
                    <Fade direction='up' delay={600} cascade damping={1e-1} triggerOnce={true}>
                        ...
                        sm:text-4xl'>Evertything you need to deliver faster</p>
                    </Fade>
                    <Fade direction='up' delay={800} cascade damping={1e-1} triggerOnce={true}>
                        <p className='mt-6 text-lg leading-8 text-black dark:text-white'>
                            It's wide array of extremely useful @ user-friendly elements and features turn website
                            creation into a cakewalk. Get started now & see just how east its is to make the website
                            you always wanted.
                        </p>
                    </Fade>
                </div>
